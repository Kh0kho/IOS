...
extension ShopViewController: UICollisionBehaviorDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if collectionView == categories {
            ...
            let productViewController = ProductViewController(prduct: filteredProductsData[indexPath.row], delegate: self)
